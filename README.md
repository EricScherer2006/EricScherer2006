...
I'm Eric Scherer, a Software Engineering student with a focus on backend development, DevOps, and test automation, constantly learning and improving how I build systems.
...
- **Goals:**
  - Working student positions and internships in Germany
  - Deepening my knowledge in DevSecOps and full-stack development
  - Building a professional developer network
...
[Full source code and detailed readme over at GitLab](https://gitlab.com/eric-scherer/devsecops-portfolio)

---

## Other projects

- **Gym Tracker** – A React-based web app for tracking and managing workouts, with a weekly overview and input for weights and exercises.
  [Live demo on Netlify](https://eric-gym-tracker.netlify.app/)

- **Network Traffic Monitor** – A network sniffer that detects IP packets in real time and categorizes them by type (TCP, UDP, ICMP, etc.), displaying packet info for analysis. The demo uses simulated traffic to protect privacy.
  [View repository](https://github.com/EricScherer2006/network-traffic-monitor.git)

---

## What you'll find here

On my GitHub you'll find a selection of my current and past hobby projects, with detailed READMEs and code samples.

---

## Contact & CV

Want to get in touch? Reach me on [LinkedIn](https://www.linkedin.com/in/YOUR-LINKEDIN) — or directly by email: scherereric9@gmail.com

---

Thanks for stopping by! I'm always open to feedback, networking, and interesting new projects.
